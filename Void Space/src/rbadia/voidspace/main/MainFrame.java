...
public class MainFrame extends JFrame {
	...
	public JLabel shieldLabel;
	public JProgressBar shieldProgress;
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			shieldLabel = new JLabel("Shield Left: ");
			shieldProgress = new JProgressBar();
		shieldProgress.setMaximum(100);


			jContentPane = new JPanel();
			jContentPane.setLayout(new GridBagLayout());
			jContentPane.add(getGameScreen(), gridBagConstraints);
			jContentPane.add(shieldLabel, gridBagConstraints5);
			jContentPane.add(shieldProgress, gridBagConstraints6);
	...
	public GameScreen getGameScreen() {
		if (gameScreen == null) {
			...
			gameScreen.setShieldprogress(shieldProgress);
		}
		return gameScreen;
	}
